...
public partial class AvaloniaScannerView : Avalonia.Controls.UserControl
{
    private ZXing.Net.Maui.Controls.CameraBarcodeReaderView? cameraBarcodeReaderView;

    public AvaloniaScannerView()
    {
        InitializeComponent();
    }

    public AvaloniaScannerView(ScannerViewAvaloniaViewModel viewModel)
    {
    ...
    protected override void OnLoaded(Avalonia.Interactivity.RoutedEventArgs e)
    {
        ...
        if (DataContext is ScannerViewAvaloniaViewModel vm)
        {
    ...
    private void BarcodesDetected(object? sender, ZXing.Net.Maui.BarcodeDetectionEventArgs e)
    {
        ...
        {
            if (e.Results.Length == 1 && DataContext is ScannerViewAvaloniaViewModel vm)
